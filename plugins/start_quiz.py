    ...
    def start_quiz_handler(bot, chat_id, quiz_id):
        ...
        with lock:
            if chat_id in active_quizzes:
                bot.send_message(chat_id, "📢 *आप पहले से ही एक क्विज़ में भाग ले रहे हैं!* ⏳\nकृपया पहले इसे पूर्ण करें, तभी आप नई क्विज़ प्रारंभ कर सकेंगे। ✅\nजब तक वर्तमान क्विज़ संपन्न नहीं होती, नई क्विज़ आरंभ नहीं होगी। 🚫", parse_mode="MarkdownV2")
                return
